  ...
  return (
    <div className="text-justified">
      ...
      <p>
        ...
        to my virtual location. <WelcomeText />
      </p>
    </div>
  );
}
...
export function WelcomeText() {
  return (
    <>
      ...
      <br />
      <br />
      I like discussing the latest tech trends, to explain, teach whatever I
      know or learned recently. I believe knowledge is only beautiful when it is
      shared. I also love to learn new stuff. My philosphy/rule to start
