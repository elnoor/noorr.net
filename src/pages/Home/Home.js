...
export const WelcomeText = (
  <>
    ...
    <br />
    <br />
    I enjoy discussing the latest technology trends and sharing my knowledge and
    insights with others. I believe that knowledge is only valuable when it's
    shared, and I'm always eager to learn something new. My rule for learning is
    "meeting twice". When I first encounter something new, I ignore it. But if I
    see it a second time, I know I must learn it and apply it wherever I can.
    <br />
